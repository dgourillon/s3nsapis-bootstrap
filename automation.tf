...
module "automation-project" {
  ...
  services = concat(
    [
     ...
     # "billingbudgets.googleapis.com", API not available in S3NS
     # "cloudasset.googleapis.com", API not available in S3NS
      "cloudbilling.googleapis.com",
      "cloudkms.googleapis.com",
     # "cloudquotas.googleapis.com", API not available in S3NS
      "cloudresourcemanager.googleapis.com",
      "essentialcontacts.googleapis.com",
      "iam.googleapis.com",
      "iamcredentials.googleapis.com",
     # "networksecurity.googleapis.com", API not available in S3NS
      "orgpolicy.googleapis.com",
      "pubsub.googleapis.com",
     # "servicenetworking.googleapis.com", API not available in S3NS
     # "serviceusage.googleapis.com", API not available in S3NS
     # "stackdriver.googleapis.com", API not available in S3NS
    ...
    var.bootstrap_user != null ? [] : [
      #"cloudbuild.googleapis.com", API not available in S3NS
